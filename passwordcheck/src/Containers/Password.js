...
class Password extends Component {
	state={value:'',suggestion:'',result:'Enter Your Password',bgColor:'',division:0,score:0}
	inputRef = React.createRef();
    render() {
		
		const ok = (e)=>{
			if(e.target.value===''){
				this.setState({value:'',suggestion:'',result:'Enter Your Password',bgColor:'',division:0,score:0})
				return;
			}
			...
			this.setState({suggestion:check.feedback.suggestions})
